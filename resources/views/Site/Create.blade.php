            ...
            <div class="col">
                <div class="card bg-default shadow shadow-dark">
                    ...
                    <div class="card-header bg-transparent border-0">
                        <h3 class="text-white mb-0">Add Rectors</h3>
                    </div>
                    {{-- Error Handling --}}
                    @if ($errors->any())
                    ...
                    <form class="form-horizontal" action="{{ route('Site.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="box-body">
                            <div class="form-group">
                                <div class="col-sm-12">
                                    <img id="profile-img" src="{{ asset('ProfileImg') }}/DefaultPPimg.jpg" width="100" height="100" data-id="">
                                    <div>
                        ...
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <div class="col-sm-12">
                                    <input type="text" class="form-control form-inputs" placeholder="Ex: John Doe" id="s_fullname" name="s_fullname">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-12">
                                    <select class="form-control form-inputs" name="s_remark" id="s_remark" onchange="setNumberPlaceholder()">
                                        ...
                                        <option value="Co-Rector">Co-Rector</option>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-12">
                                    <select class="col-sm-2 form-multi-control form-inputs" name="s_num_stat" id="s_num_stat" onchange="setNumberType(this)">
                                        <option value="s_nidn">NIDN</option>
                                        <option value="s_nidk">NIDK</option>
                                        <option value="s_nip">NIP</option>
                                    </select>
                                    <input type="tel" class="col-sm-10 form-multi-control form-inputs float-right lecture-num" placeholder="Rector NIDN Number" name="s_nidn" id="s_nidn">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="s_education" class="control-label text-white">Education</label>
                                <div class="col-sm-12">
                                    <textarea class="form-control form-inputs" placeholder="Ex: Harvard University 2012-2016" name="s_education" id="s_education"></textarea>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="s_experience" class="control-label text-white">Experiences</label>
                                <div class="col-sm-12">
                                    <textarea class="form-control form-inputs" placeholder="Ex: 1 Year Lecturer in Harvard" name="s_experience" id="s_experience"></textarea>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="s_address" class="control-label text-white">Address</label>
                                <div class="col-sm-12">
                                    <input type="text" class="form-control form-inputs" placeholder="Ex: Silicon Valley Street No 76th" id="s_address" name="s_address">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="s_province" class="control-label text-white">Province</label>
                                <div class="col-sm-12">
                                    <input type="text" class="form-control form-inputs" placeholder="Ex: Brooklyn" id="s_province" name="s_province">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="s_city" class="control-label text-white">City</label>
                                <div class="col-sm-12">
                                    <input type="text" class="form-control form-inputs" placeholder="Ex: New York City" id="s_city" name="s_city">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="s_birthplace" class="control-label text-white">Birthplace</label>
                                <div class="col-sm-12">
                                    <input type="text" class="form-control form-inputs" placeholder="Ex: Huston" id="s_birthplace" name="s_birthplace">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="s_birthdate" class="control-label text-white">Birthdate</label>
                                <div class="col-sm-12">
                                    <input type="date" class="form-control form-inputs" placeholder="Birthdate" id="s_birthdate" name="s_birthdate">
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-12">
                                    <input type="email" class="form-control form-inputs" placeholder="Ex: john@gmail.com" id="s_email" name="s_email">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="s_contact" class="control-label text-white">Contact</label>
                                <div class="col-sm-12">
                                    <input type="tel" class="form-control form-inputs" placeholder="Ex: +628902192xxxx" id="s_contact" name="s_contact">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="s_state" class="control-label text-white">Country of Origin</label>
                                <div class="col-sm-12">
                                    <input type="tel" class="form-control form-inputs" placeholder="Ex: Indonesia" id="s_state" name="s_state">
                                </div>
                            </div>
                            <div class="form-group">
