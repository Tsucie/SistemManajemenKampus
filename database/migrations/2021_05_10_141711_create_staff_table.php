    ...
    public function up()
    {
        ...
        if (!Schema::hasTable('staff'))
        {
            Schema::create('staff', function (Blueprint $table) {
                ...
                $table->integer('stf_u_id');
                $table->integer('stf_sc_id');
                $table->integer('stf_fks_id')->nullable();
                $table->integer('stf_ps_id')->nullable();
                $table->integer('stf_mk_id')->nullable();
                $table->string('stf_fullname',150);
                $table->string('stf_num_stat',8);
