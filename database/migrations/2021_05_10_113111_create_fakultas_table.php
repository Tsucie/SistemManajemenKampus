    ...
    public function up()
    {
        ...
        if (!Schema::hasTable('fakultas'))
        {
            Schema::create('fakultas', function (Blueprint $table) {
                $table->integerIncrements('fks_id')->unique('fks_id_UNIQUE');
                ...
                $table->dateTime('fks_rec_updated')->default(date('Y-m-d H:i:s'));
                $table->string('fks_rec_deletedby',150)->nullable();
                $table->dateTime('fks_rec_deleted')->default(date('Y-m-d H:i:s'));
