    ...
    public function up()
    {
        ...
        if (!Schema::hasTable('users'))
        {
            Schema::create('users', function (Blueprint $table) {
                ...
                $table->dateTime('u_login_time')->default(date('Y-m-d H:i:s'));
                $table->dateTime('u_logout_time')->default(date('Y-m-d H:i:s'));
                $table->smallInteger('u_login_status');
                ...
                $table->dateTime('u_rec_updated')->default(date('Y-m-d H:i:s'));
                $table->string('u_rec_deletedby',150)->nullable();
                $table->dateTime('u_rec_deleted')->default(date('Y-m-d H:i:s'));
